<?php
    ...
    $baris = $kat->tampilBy_IdKat($_GET['id']);

    $berita = new Berita();
    $data = $berita->tampilBerita_ByKat($_GET['id']);
...
<div class="container">
    <div class="row">
        <div class="col-sm-5 ml-5 mt-3">
            <h1 style="color: grey;font-family: 'poppins';margin-left: 10px"><?= $baris['nama_kat']; ?></h1>
        </div>
    </div>
    <div class="row ml-5">
            ...
            <div class="card border-0 rounded-0 text-white overflow zoom">
                <div class="position-relative">
                    ...
                    <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                        <!-- category -->
                        <a class="p-1 badge badge-primary rounded-0" href=""><?= $row['nama_kat']; ?></a>
                        <!--title-->
